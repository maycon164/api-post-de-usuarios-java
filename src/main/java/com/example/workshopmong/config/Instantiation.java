...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post p1 = new Post(null, sdf.parse("02/09/2018"), "Partiu São paulo", "Estou viajando amanhã para SP", bob);
		Post p2 = new Post(null, sdf.parse("02/12/2020"), "Sangue de Jesus tem poder", "REAAU OU FEIKI", maria);
